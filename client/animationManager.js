...
export class AnimationManager {
  ...
  // VRMA/Mixamo state methods
  setVRMAPlaying(playing) { this._vrmaPlaying = playing; }
  isVRMAPlaying() { return !!this._vrmaPlaying; }
  setMixamoPlaying(playing) { this._mixamoPlaying = playing; }
  isMixamoPlaying() { return !!this._mixamoPlaying; }
}